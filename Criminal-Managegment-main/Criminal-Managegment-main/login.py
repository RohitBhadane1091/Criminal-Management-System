...
class Login_Window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\heman\OneDrive\Desktop\criminal\images\ncr_logo.jpeg")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            try:
                con=mysql.connector.connect(host='localhost', username='root',password='HEMANTspatil@1707', database='temp1')
                cur=con.cursor() 
